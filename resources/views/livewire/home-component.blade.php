		...
		<div class="container">
			...
			<div class="wrap-main-slide">
				<div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true" data-dots="true">
                    ...
                    <div class="item-slide" style="height: 600px">
						<img src="{{ asset('assets/images/sliders') }}/{{$slide->image}}" alt="" class="img-slide">
                          <div class="slide-info slide-1">
							<h2 class="f-title"><b  style="color: rgb(236, 235, 235)">{{$slide->title}}</b></h2>
							<span class="subtitle" style="color: rgb(226, 225, 225)">{{$slide->subtitle}}</span>
